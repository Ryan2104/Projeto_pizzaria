        ...
        <div class="container text-center">
            <div class="row align-items-center">
                ...
                <div class="col text-center">
                    <span style="color: red; font-size: 30px;">Atendimento</span>
                </div>
        ...
        <div class="container " style="width:75%;float: right;">
            <div class ="row-xl">
                ...
                <div class="row" style="border-bottom: 2px solid black;margin-bottom: 10px;">
                    ...
                    <div class ="col-3">
                    <h5 style="text-align: left;">Pedidos</h5>
                    </div>
            ...
            <br>
        <div class ="row-xl">
            <div class ="col-12"><h3>Pedidos Delivery</h3><hr></div>
                <div class="row" style="border-bottom: 2px solid black;margin-bottom: 10px;">
                            <div class="col-1">
                                <h5 >Cód</h5>
                            </div>
            ...
            <div class="row">
                ...
                <div class =" col " style ="border-bottom: 1px solid rgba(0, 0, 0, 0.233)">
                    <label for="" style="font-size: 14px; color: rgb(0, 0, 0)">1221</label>
                </div>
                ...
                <!–-ENDEREÇO-–>
                <div class =" col-2" style ="border-bottom: 1px solid rgba(0, 0, 0, 0.233)">
                    <label for="" style="font-size: 14px; color: rgb(0, 0, 0);">R. São João, 43 – apto 43 -Centro – São Vicente
                    </label>
                </div>
                ...
                <div class =" col-1 t" style ="border-bottom: 1px solid rgba(0, 0, 0, 0.233)">
            ...
            <div class="col-8">
                <h3>Restaurante</h3>
                    ...
                    <div class ="d-grid gap-2 col-12 auto"> 
                        ...
                        <a  class="btn btn-primary btn-danger" type="button">Novo pedido</a>
                        <a class="btn btn-primary btn-danger" type="button">Fechar mesa</a>
                    </div>
                        <br>
                        <br>
                    <h3>Delivery</h3>
                    ...
                    <div class ="d-grid gap-2 col-12 auto">
                        ...
                        <a class="btn btn-primary btn-danger" >Novo pedido</a>
                    </div>
                    <br>
                    <br>
                    <h3>Atendimento</h3>
                        <hr>
                    <div class ="d-grid gap-2 col-12 auto">
                        <a href="atendimento.html" class="btn btn-primary btn-danger active">Atendimento</a>
